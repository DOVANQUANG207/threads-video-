...
def imagemaker(theme, post_data: dict, txtclr, padding=5, transparent=False) -> None:
    """
    Render Images for video
    """
    texts = post_data["thread_post"]
    ...
    for idx, text in track(enumerate(texts), "Rendering Image"):
        ...
        image.save(f"assets/temp/{post_id}/png/img{idx}.png")
