...
This directory contains scripts and configs for training, fine-tuning, and evaluating GHVoice.
...
NUM_GPUS=2
OUTPUT_DIR="exp/GHvoice_finetune"      # output directory
```
