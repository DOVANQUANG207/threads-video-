...
"""Batch inference CLI for GHVoice.
...
Usage:
    GHvoice-infer-batch --model k2-fsa/OmniVoice \
...
from voices.models.GHvoice import GHVoice
import soundfile as sf

from voices.utils.audio import load_audio
from voices.utils.common import str2bool
...
def get_parser():
    parser = argparse.ArgumentParser(description="Infer GHVoice Model")
    parser.add_argument(
        "--model",
        type=str,
...
def process_init(rank_queue, model_checkpoint, warmup=0):
    ...
    worker_model = GHVoice.from_pretrained(
        model_checkpoint,
