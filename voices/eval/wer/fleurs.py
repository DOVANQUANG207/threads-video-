...
Usage:
    python3 GHvoice/eval/wer/fleurs.py \\
...
# GHvoice/__init__.py heavy imports.
if "GHvoice" not in sys.modules:
...
from voices.eval.wer.common import log_metrics, process_one
from voices.eval.wer.text_norm_omni import text_normalize
...
# fix mismatched language codes between GHVoice and Omnilingual-ASR model
rename = {
    "et": "ekk",
    "ms": "zsm",
    "sw": "swh",
