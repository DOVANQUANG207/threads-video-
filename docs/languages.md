...
GHVoice supports **646 languages** with a total of **581k hours** of training data.

The table below lists each language with its GHVoice language ID,
ISO 639-3 code, and training data duration (hours).

| # | Language | GHVoice ID | ISO 639-3 | Duration (h) |
|--:|----------|:------------:|:---------:|:------------:|
